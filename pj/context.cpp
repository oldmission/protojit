...
Portal* ProtoJitContext::schemaPortal() {
  ...
  PJContext* ctx = reinterpret_cast<PJContext*>(this);
  auto host_domain = reinterpret_cast<const PJDomain*>(
      types::HostDomainAttr::get(&ctx_).getAsOpaquePointer());
  auto schema_host = mlir::Type::getFromOpaquePointer(
      gen::BuildPJType<reflect::Protocol>::build(ctx, host_domain));
