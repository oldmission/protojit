...
struct BuildPJType<::v0_2::pj::reflect::InlineVariant> {
  static const auto* build(PJContext* ctx, const PJDomain* domain) {
    ...
    const auto* _37 = BuildPJType<::v0_2::pj::Width>::build(ctx, domain);
    fields[2] = PJCreateStructField(/*name=*/"term_offset", /*type=*/_37,
                                    /*offset=*/256);
    const auto* _38 = BuildPJType<::v0_2::pj::Width>::build(ctx, domain);
    fields[3] =
        PJCreateStructField(/*name=*/"term_size", /*type=*/_38, /*offset=*/320);
    const auto* _39 = BuildPJType<::v0_2::pj::Width>::build(ctx, domain);
    fields[4] = PJCreateStructField(/*name=*/"tag_offset", /*type=*/_39,
                                    /*offset=*/384);
    const auto* _40 = BuildPJType<::v0_2::pj::Width>::build(ctx, domain);
    fields[5] =
        PJCreateStructField(/*name=*/"tag_width", /*type=*/_40, /*offset=*/448);
    const auto* _41 = BuildPJType<::v0_2::pj::Width>::build(ctx, domain);
    fields[6] =
        PJCreateStructField(/*name=*/"size", /*type=*/_41, /*offset=*/512);
    const auto* _42 = BuildPJType<::v0_2::pj::Width>::build(ctx, domain);
    fields[7] =
...
struct BuildPJType<::v0_2::pj::reflect::Int> {
  static const auto* build(PJContext* ctx, const PJDomain* domain) {
    ...
    const auto* _50 = BuildPJType<::v0_2::pj::Width>::build(ctx, domain);
    fields[0] =
        PJCreateStructField(/*name=*/"width", /*type=*/_50, /*offset=*/0);
    const auto* _51 = BuildPJType<::v0_2::pj::Width>::build(ctx, domain);
    fields[1] =
        PJCreateStructField(/*name=*/"alignment", /*type=*/_51, /*offset=*/64);
    const auto* _52 = BuildPJType<::v0_2::pj::Sign>::build(ctx, domain);
    fields[2] =
...
struct BuildPJType<::v0_2::pj::reflect::OutlineVariant> {
  static const auto* build(PJContext* ctx, const PJDomain* domain) {
    ...
    fields[4] = PJCreateStructField(/*name=*/"term_offset", /*type=*/_62,
                                    /*offset=*/384);
    const auto* _63 = BuildPJType<::v0_2::pj::Width>::build(ctx, domain);
...
struct BuildPJType<::v0_2::pj::reflect::Struct> {
  static const auto* build(PJContext* ctx, const PJDomain* domain) {
    ...
    const auto* _77 = BuildPJType<::v0_2::pj::Width>::build(ctx, domain);
    fields[2] =
        PJCreateStructField(/*name=*/"size", /*type=*/_77, /*offset=*/256);
    const auto* _78 = BuildPJType<::v0_2::pj::Width>::build(ctx, domain);
    fields[3] =
...
struct BuildPJType<::v0_2::pj::reflect::Vector> {
  static const auto* build(PJContext* ctx, const PJDomain* domain) {
    ...
    fields[8] = PJCreateStructField(/*name=*/"reference_mode", /*type=*/_95,
                                    /*offset=*/480);
    const auto* _96 = BuildPJType<::v0_2::pj::Width>::build(ctx, domain);
    fields[9] = PJCreateStructField(/*name=*/"inline_payload_offset",
                                    /*type=*/_96, /*offset=*/488);
    const auto* _97 = BuildPJType<::v0_2::pj::Width>::build(ctx, domain);
    fields[10] = PJCreateStructField(/*name=*/"partial_payload_offset",
                                     /*type=*/_97, /*offset=*/552);
    const auto* _98 = BuildPJType<::v0_2::pj::Width>::build(ctx, domain);
    fields[11] =
...
struct BuildPJType<::v0_2::pj::reflect::Type> {
  static const auto* build(PJContext* ctx, const PJDomain* domain) {
    ...
    terms[6] = PJCreateTerm(/*name=*/"Vector", /*type=*/_108, /*tag=*/71);
    ...
    const PJInlineVariantType* _110 = PJCreateInlineVariantType(
        ...
        /*num_terms=*/7, /*terms=*/terms, /*term_offset=*/8, /*term_size=*/744,
        /*tag_offset=*/0, /*tag_width=*/8, /*size=*/752, /*alignment=*/8);
    return _110;
  }
};
}  // namespace gen
...
struct BuildPJType<::v0_2::pj::reflect::Protocol> {
  static const auto* build(PJContext* ctx, const PJDomain* domain) {
    ...
    const auto* _113 = BuildPJType<::v0_2::pj::Width>::build(ctx, domain);
